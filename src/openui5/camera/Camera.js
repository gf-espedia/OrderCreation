...
sap.ui.define([
    ...
    'sap/ui/core/Control'
              ...
              function(jQuery, Control) {
                   ...
                   */
                  var oCamera = Control.extend("openui5.camera.Camera", {			//Control API
                        metadata: {
                          properties: {
                              "width": {			//Width of the preview window in pixels
                                  type: "string",
                                  defaultValue: "640"
                              },
                              "height": {		//Height of the preview window in pixels
                                  type: "string",
                                  defaultValue: "480"
                              },
                              "videoWidth": {		//Width of the video capture window in pixels
                                  type: "string",
                                  defaultValue: "1280"
                              },
                              "videoHeight": {		//Height of the video capture window in pixels
                                  type: "string",
                                  defaultValue: "960"
                              }
                          },
                          ...
                          if (oVideo && !this._displayingVideo) {
                              ...
                              navigator.mediaDevices.getUserMedia({
                                  ...
                                  .then(function(stream) {
                                      // We have a camera. Let's store the stream for later use  ---------------> VIDEO
                                      that._stream = stream;
